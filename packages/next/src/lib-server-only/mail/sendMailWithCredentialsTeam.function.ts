...
export async function sendMailWithCredentialsTeam(email: string, name: string, id: string) {
    return await mail(
        ...
        `<h1>Deine Anmeldung zum Gießener 24-Stunden-Schwimmen (2026)</h1>
         <p>Mit dieser Mail erhältst Du den Link zu deinen Anmeldedaten und live Fortschritten deines Teams. <b>Behandel diesen Link vertraulich!</b> Sollten Änderungen nötig sein, kannst du diese beim Check-In am Veranstaltungstag vornehmen lassen.</p>
         <p>Team: ${name}</p>
