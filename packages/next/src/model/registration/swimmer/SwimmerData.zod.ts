...
export const SwimmerData = z.object({
    ...
    gender: z.enum(["0", "M", "W"]).nullish(),
    city: z.string().min(2, { error: "Der Ort muss mindestens 2 Buchstaben haben" }).max(255, {error: "Der Ort darf nicht mehr als 255 Buchstaben haben" }).nullish(),
