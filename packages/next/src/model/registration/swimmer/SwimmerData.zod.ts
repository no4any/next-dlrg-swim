...
export const SwimmerData = z.object({
    ...
    firstName: z.string().min(2, { error: "Der Vorname muss mindestens 2 Buchstaben haben" }),
    lastName: z.string().min(2, { error: "Der Nachname muss mindestens 2 Buchstaben haben" }),
