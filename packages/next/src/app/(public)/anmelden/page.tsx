    ...
    return <div>
        <div>
            <header className="mb-4">
                ...
                <div>
                    <p>Hier melden Sie sich unverbindlich zur 24 Stunden Schwimmer 2026 an. Nach erfolgreicher Anmeldung erhalten Sie eine E-Mail mit Ihren Zugangsdaten. <span className="text-dlrg-red font-bold">Behandeln Sie den enthaltenen Link vertraulich.</span></p>
