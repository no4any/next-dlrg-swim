    ...
    return <div>
        ...
        <Form action={formAction}>
            ...
            <div className="flex flex-col gap-2 mt-4">
                <CheckBox name="noPublishName" disabled={pending}><p>Ich möchte <span className="font-bold underline">NICHT</span> namentlich genannt werden <span className="font-bold italic text-dlrg-red">(Führt zum Ausschluss von allen individuellen Wertungen und Siegerehrungen - <span className="underline">Leistungen werden dem Team jedoch angerechnet</span>)</span></p></CheckBox>
